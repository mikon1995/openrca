...
user = """Now, I need you to provide a root cause analysis to the following question:
...
{
  "component": "(the root cause component, strictly from the candidate list)",
  "reason": "(the root cause reason, concise and covering key indicators or log keywords)",
  "reasoning_trace": [
    {
      "step": 1,
      "action": "...",
