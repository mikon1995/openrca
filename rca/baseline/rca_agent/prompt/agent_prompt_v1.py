...
# 2. Data time format rules:
#     - The time contained in the data file name is in UTC timezone. For example, in 'log_filebeat-server_2025-06-05_16-00-00.parquet', the time '2025-06-05_16-00-00' means 2025-06-05 16:00:00 UTC, which is 2025-06-06 00:00:00 in Beijing time (UTC+8).
#     - The time in log data is in the format '2025-06-05T16:00:29.045Z', which is UTC timezone. For example, '2025-06-05T16:00:29.045Z' means 2025-06-06 00:00:29.045 in Beijing time (UTC+8).
#     - The time in metric data is in the format '2025-06-05T16:00:00Z', which is UTC timezone. For example, '2025-06-05T16:00:00Z' means 2025-06-06 00:00:00 in Beijing time (UTC+8).
#     - The 'startTimeMillis' field in trace data is a timestamp in milliseconds.
# 3. When parsing or converting time columns in pandas, you SHOULD use the following robust function to safely handle both tz-naive and tz-aware timestamps:
#     def to_shanghai(dt):
